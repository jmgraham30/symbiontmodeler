...
[symbiont](https://en.wikipedia.org/wiki/Symbiosis) frequency dynamics.
Applications to [wolbachia](https://en.wikipedia.org/wiki/Wolbachia)
frequency dynamics are emphasized, but the models are general enough to
be applied to other symbionts.
